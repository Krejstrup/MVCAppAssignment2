...
function ajaxGetAll(event) {
    ...
    $.get("Country/AllCountries", function (data, status) {          /* goto  "Controller/Function"  */
...
function ajaxFilter(event) { 
    ...
    $.post("Country/Filter", {Id: idTexField.value},function (data, status) {
        if (status == "success") {
            resultContainer.innerHTML = data;
        }
...
function ajaxRemove(element, event) {
    ...
    $.post("Country/Remove", { Id: idTexField.value }, function (data, status) {
...
function About(id, event) {
    ...
    $.post("Country/About", { Id: id }, function (data, status) {
...
function CloseAbout(id, event) {     
    ...
    $.post("Country/NotAbout", { Id: id }, function (data, status) {
...
function DeletePerson(PersonId, event) {
    ...
    $.post("Country/Remove", { Id: PersonId }, function (data, status) {
